...
def zmlabel(categories, lens, items):
    subs = dict({'(f)r': 'r(f)', 'abcrxyz':'srf', '(xyz)abcr':'sr(f)', '(abc)(rxyz)':'(s)(rf)', '(abc)rxyz':'(s)rf', '(abc)(r)(xyz)':'(s)(r)(f)', '(abc)(xyz)r':'(s)r(f)', '(xyz)(c)(b)(a)r':'(a)(b)(c)r(f)', '(r)(xyz)(c)(b)(a)':'(a)(b)(c)(r)(f)', '(xyz)(abcr)':'(sr)(f)'})
...
def zlabel(categories, items):
    subs = dict({'(r)(sf)':'(sf)(r)', '(abcrxyz)': '(srf)', '(xyz)(abcr)': '(sr)(f)', '(abc)(rxyz)':'(s)(rf)', '(abc)(r)(xyz)':'(s)(r)(f)', '(abcr)(xyz)':'(sr)(f)', '(a)(b)(c)(rxyz)':'(a)(b)(c)(rf)'})
    categories.sort()
    strp = [''.join(map(str, items[c])) for c in categories]
    lab = '(' + ')('.join(strp) + ')'
    if lab in subs:
